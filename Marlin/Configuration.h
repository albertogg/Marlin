...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Creality Ender-3 Pro
    ...
    #define DEFAULT_Kd_LIST { 70.40, 70.40 }
  #else
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // PID tuned for 80 Celsius
  #define DEFAULT_bedKp 211.99
  #define DEFAULT_bedKi 42.36
  #define DEFAULT_bedKd 707.35
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -13, -2.79 }
